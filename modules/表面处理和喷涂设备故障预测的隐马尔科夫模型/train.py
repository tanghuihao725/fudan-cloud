...
吊机使用时间x(0) 满足均值为5，标准差为1的正态分布
吊机长度 x(1) 满足最大值10，最小值0.1的均匀分布
吊机每吊速度 x(2) 满足均值12，标准差3的正态分布
吊机横截面积 x(3)满足最大值5，最小值1的均匀分布
每吊重量 x(4) 满足均值为500，标准差为100的正态分布
吊数：随机为1-4之间的数
吊机操作人员的人数x(6) 随机为1-9之间的数
吊机人员团队的熟练度 随机0-1之间的数
'''
