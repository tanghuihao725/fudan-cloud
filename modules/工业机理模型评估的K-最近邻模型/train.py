...
if __name__ == "__main__":
    ...
    kNN_classifier.fit(train_x,y_train)  # fit 拟合           返回值是机器学习类本身

    # y_predict = kNN_classifier.predict(train_x)
    #
    # print(y_predict)
    # import pickle
    ...
    import pickle
    output = open('./model/model_kNN_classifier.pth', 'wb')
    s = pickle.dump(kNN_classifier, output)
    output.close()
